...
$(document).ready(function () {
    ...
    $(document).on('click', 'a.venus-modal-open, button.venus-modal-open', function (e) {
        ...
        //console.log(data);
        $('div.venus-modal[data-modal="' + data + '"]').show();

        // pour le mobile, on adapte
        //if( $('.onDesktop').css('display')=='none') {
        //    $('div.venus-modal[data-modal="' + data + '"]')
        //        .css('top', $(window).scrollTop()+'px');
        //}

        // Si click dans le contenu, on ne fait rien
        $('div.venus-modal-content').click(function (e) {
            e.stopPropagation();
        });

        // Fermeture de la modal
        $('div.venus-modal').click(function (e) {
            e.preventDefault();
            venusModalClose();
        });
        $('a.venus-modal-close').click(function (e) {
            e.preventDefault();
            //console.log($(this).data('venus-modal-close-callback'));

            if(
                $(this).data('venus-modal-close-callback')!=undefined
            ){
                console.log('callback');
                var fnstring = $(this).data('venus-modal-close-callback')+'()';
                var fnparams = null;
        ...
        $('div.venus-modal-content a').click(function (e) {
